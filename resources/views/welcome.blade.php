...
<body>
    ...
    <section class="naslovnica" id="naslovnica">
        <!--<h1>Priđi, kupi jer nismo skupi &#128526 </br>
            Usrećiti Vas nam je glavna misao </br>zato za Vas smo spremili </br>
    ...
    <section class="o_nama" id="o_nama">
        <div class="row">
            <div class="col50">
                ...
                <p> SportAMA je najveći online prodajni lanac na svijetu za djecu i odrasle. U ponudi ima više od 200 000 proizvoda koje
                    prodaje 250+ prodavača-partnera iz BiH i EU. Cilj nam je obući svakog čovjeka u najljepšu i najkvalitetniju robu, te
                    nam je na prvom mjestu udobnost proizvoda i zadovoljstvo kupca.
                    Na jednom mjestu imate sve, od fitnes opreme, sportske odjeće, do opreme za različite sportove: karate, kickboks,
                    ...
                    Pokretači projekta su studentice studija Matematika-Informatika. Kako su zamislile svoj projekt, koji im je cilj,
                    motivacija te koje tehnologije će koristiti možete pogledati
                    <a href="file:///C:/Users/HOME/Desktop/SportAma-PZI/SportAma_Vizija_2.pdf" target="_blank" rel="noreferrer" class="link">ovdje</a>.
                    <br><br>
                    Izaberi za sebe najbolji proizvod iz našeg asortimana i iznenadi svoju budućnost!</p></span>
        ...
        <div class="content">
            <div class="box">
                <div class="imgBx">
                    ...
                    <img src="img/proizvodi/muska_trenerka.png" alt="Muška trenerka" width="600" height="400"></a>
                </div>
    ...
    <!----------------------------------------------------------------------------------->
                <div class="box">
                    <div class="imgBx">
                        ...
                        <img src="img/proizvodi/tajice.png" alt="Ženske tajice" width="600" height="400"></a>
                    </div>
    ...
    <section class="kontakt" id="kontakt">
        <div class="contactForm">
            <div class="title">
                ...
                <p>TU SMO ZA VAS 0-24h </br> Pošalji nam poruku</p>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="footer-col">
                    ...
                    <ul>
                        <li><a href="#proizvodi">Odjeća</a></li>
                        <li><a href="#proizvodi">Obuća</a></li>
